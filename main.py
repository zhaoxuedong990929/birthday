...
def get_weather(region):
    ...
    if int(response['HeWeather6'][0]["daily_forecast"][0]["tmp_max"]) <= 20:
        xigua = "今天天气有点冷，佳佳子多穿点衣服哦~"
    elif int(response['HeWeather6'][0]["daily_forecast"][0]["tmp_max"]) <= 28:
        xigua = "今天温度正好，可以穿漂亮衣服了呢~"
    else:
    ...
    for key, value in birthdays.items():
        ...
        # 获取距离下次生日的时间
            ...
            if yima_day >= 23 :
                ...
                birthday_data = "佳佳子最近少吃点凉的哦，还有{}天就要来姨妈了".format(yima_day)
            else:
